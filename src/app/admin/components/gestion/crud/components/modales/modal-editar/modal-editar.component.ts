...
export class ModalEditarComponent implements OnInit, OnChanges {
  ...
  inicializarFormularios(): void {
    this.formE = this.fb.group({
      ...
      correosGroup: this.fb.group({
        correo1: ['', [Validators.pattern('^[a-zA-ZñÑ0-9._%+-]+@[a-zA-ZñÑ0-9.-]+\\.[a-zA-ZñÑ]{2,}$')]],
        correo2: ['', [Validators.pattern('^[a-zA-ZñÑ0-9._%+-]+@[a-zA-ZñÑ0-9.-]+\\.[a-zA-ZñÑ]{2,}$')]],
        correo3: ['', [Validators.pattern('^[a-zA-ZñÑ0-9._%+-]+@[a-zA-ZñÑ0-9.-]+\\.[a-zA-ZñÑ]{2,}$')]]
      }),
    ...
    this.formR = this.fb.group({
      ...
      correo: ['', [Validators.required, Validators.pattern('^[a-zA-ZñÑ0-9._%+-]+@[a-zA-ZñÑ0-9.-]+\\.[a-zA-ZñÑ]{2,}$')]],
  ...
  getErrorGroup(groupName: string, controlName: string): string {
    ...
    if (control.hasError('email')) return 'Ingrese un correo electrónico válido.';
    if (control.hasError('pattern')) {
      if (controlName.includes('correo')) return 'Ingrese un correo electrónico válido.';
      if (controlName.includes('telefono')) return 'Ingrese un teléfono válido (9 dígitos, comenzando por 6, 7, 8 o 9).';
    }
